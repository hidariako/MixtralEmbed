...
const contractABI = require("../artifacts/contracts/Mixtralembed.sol/Mixtralembed.json").abi;

program
    .name("mixtralembed-cli")
    .description("CLI tool for Mixtralembed smart contract")
    .version("1.0.0");
